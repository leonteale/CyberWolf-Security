...
* [Ports - Services](services/services-ports/README.md)
  ...
  * [443 - HTTPS](services/ports-services/443-https/README.md)
    * [IIS](services/iis.md)
  * [445 - SMB](services/services-ports/smb.md)
...
* [Red-Team](labs-resources/red-team/README.md)
  ...
  * [Vulnerable Sites](labs-resources/red-team/vulnerable-sites.md)
...
* [Certifications](certifications/certifications/README.md)
  ...
  * [Crest](training/certifications/crest/README.md)
    * [Crest CPSA](training/certifications/crest/crest-cpsa.md)
    * [Crest CRT](training/certifications/crest/crest-crt/README.md)
      * [Syllabus](training/certifications/crest/crest-crt/syllabus.md)
      * [Appendix B: Core Technical Skills](training/certifications/crest/crest-crt/appendix-b-core-technical-skills/README.md)
        * [B4 - Network Mapping & Target Identification](training/certifications/crest/crest-crt/appendix-b-core-technical-skills/b4-network-mapping-and-target-identification.md)
        * [B5 - Interpreting Tool Output](training/certifications/crest/crest-crt/appendix-b-core-technical-skills/b5-interpreting-tool-output.md)
        * [B8 - OS Fingerprinting](training/certifications/crest/crest-crt/appendix-b-core-technical-skills/b8-os-fingerprinting.md)
        * [B9 - Application Fingerprinting and Evaluating Unknown Services](training/certifications/crest/crest-crt/appendix-b-core-technical-skills/b9-application-fingerprinting-and-evaluating-unknown-services.md)
        * [B13 - File System Permissions](training/certifications/crest/crest-crt/appendix-b-core-technical-skills/b13-file-system-permissions.md)
      * [Appendix C: Background Information Gathering & Open Source](training/certifications/crest/crest-crt/appendix-c-background-information-gathering-and-open-source/README.md)
        * [C2 - Domain Name Server (DNS)](training/certifications/crest/crest-crt/appendix-c-background-information-gathering-and-open-source/c2-domain-name-server-dns.md)
      * [Appendix D: Networking Equipment](training/certifications/crest/crest-crt/appendix-d-networking-equipment/README.md)
        * [D1 - Management Protocols](training/certifications/crest/crest-crt/appendix-d-networking-equipment/d1-management-protocols.md)
        * [D3 - Networking Protocols](training/certifications/crest/crest-crt/appendix-d-networking-equipment/d3-networking-protocols.md)
      * [Appendix E: Microsoft Windows Security Assessment](training/certifications/crest/crest-crt/appendix-e-microsoft-windows-security-assessment/README.md)
        * [E1 - Domain Reconnaissance](training/certifications/crest/crest-crt/appendix-e-microsoft-windows-security-assessment/e1-domain-reconnaissance.md)
        * [E2 - User Enumeration](training/certifications/crest/crest-crt/appendix-e-microsoft-windows-security-assessment/e2-user-enumeration.md)
        * [E3 - Active Directory](training/certifications/crest/crest-crt/appendix-e-microsoft-windows-security-assessment/e3-active-directory.md)
        * [E5 - Windows Vulnerabilities](training/certifications/crest/crest-crt/appendix-e-microsoft-windows-security-assessment/e5-windows-vulnerabilities.md)
        * [E9 - Common Windows Applications](training/certifications/crest/crest-crt/appendix-e-microsoft-windows-security-assessment/e9-common-windows-applications.md)
      * [Appendix F: Unix Security Assessment](training/certifications/crest/crest-crt/appendix-f-unix-security-assessment/README.md)
        * [F1- User enumeration](training/certifications/crest/crest-crt/appendix-f-unix-security-assessment/f1-user-enumeration.md)
        * [F2 - Unix vulnerabilities](training/certifications/crest/crest-crt/appendix-f-unix-security-assessment/f2-unix-vulnerabilities.md)
        * [F3 - FTP](training/certifications/crest/crest-crt/appendix-f-unix-security-assessment/f3-ftp.md)
        * [F4 - Sendmail / SMTP](training/certifications/crest/crest-crt/appendix-f-unix-security-assessment/f4-sendmail-smtp.md)
        * [F5 - Network File System (NFS)](training/certifications/crest/crest-crt/appendix-f-unix-security-assessment/f5-network-file-system-nfs.md)
        * [F6 - R\* services](training/certifications/crest/crest-crt/appendix-f-unix-security-assessment/f6-r-services.md)
        * [F7 - X11](training/certifications/crest/crest-crt/appendix-f-unix-security-assessment/f7-x11.md)
        * [F8 - RPC services](training/certifications/crest/crest-crt/appendix-f-unix-security-assessment/f8-rpc-services.md)
        * [F9 - SSH](training/certifications/crest/crest-crt/appendix-f-unix-security-assessment/f9-ssh.md)
      * [Appendix G: Web Technologies](training/certifications/crest/crest-crt/appendix-g-web-technologies/README.md)
        * [G1 - Web Server Operation](training/certifications/crest/crest-crt/appendix-g-web-technologies/g1-web-server-operation.md)
        * [G2 - Web Servers & their Flaws](training/certifications/crest/crest-crt/appendix-g-web-technologies/g2-web-servers-and-their-flaws.md)
        * [G4 - Web Protocols](training/certifications/crest/crest-crt/appendix-g-web-technologies/g4-web-protocols.md)
        * [G7 - Web Application Servers](training/certifications/crest/crest-crt/appendix-g-web-technologies/g7-web-application-servers.md)
      * [Appendix I: Web Testing Techniques](training/certifications/crest/crest-crt/appendix-i-web-testing-techniques/README.md)
        * [I1 - Web Site Structure Discovery](training/certifications/crest/crest-crt/appendix-i-web-testing-techniques/i1-web-site-structure-discovery.md)
        * [I2 - Cross Site Scripting Attacks](training/certifications/crest/crest-crt/appendix-i-web-testing-techniques/i2-cross-site-scripting-attacks.md)
        * [I3 - SQL Injection](training/certifications/crest/crest-crt/appendix-i-web-testing-techniques/i3-sql-injection.md)
        * [I6 - Parameter Manipulation](training/certifications/crest/crest-crt/appendix-i-web-testing-techniques/i6-parameter-manipulation.md)
      * [Appendix J: Databases](training/certifications/crest/crest-crt/appendix-j-databases/README.md)
        * [J1 - Microsoft SQL Server](training/certifications/crest/crest-crt/appendix-j-databases/j1-microsoft-sql-server.md)
        * [J2 - Oracle RDBMS](training/certifications/crest/crest-crt/appendix-j-databases/j2-oracle-rdbms.md)
        * [J3 - Web / App / Database Connectivity](training/certifications/crest/crest-crt/appendix-j-databases/j3-web-app-database-connectivity.md)
